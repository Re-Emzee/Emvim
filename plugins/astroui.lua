...
return {
  {
    ...
    opts = {
      ...
      highlights = {
        init = {
            WinBar = { bg = "none" },
            --TabLineSel = { bg = "#111111", fg = "#111111" },
            --TabLine = { bg = "#101010" },
            --TabLineFill = { bg = "#101010" },
            NotifyBackground = { bg = "#101010" },
        },
      },
      ...
      status = {
        ...
        colors = function(hl)
          ...
          hl.tabline_sel_bg = "#2e2e2e"
          hl.tabline_active_fg = "#2e2e2e"
          hl.tabline_active_bg = "#101010"
